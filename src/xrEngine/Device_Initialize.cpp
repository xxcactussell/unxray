...
void CRenderDevice::Initialize()
{
    ...
    // This is mostly for consistency, so that our code can use same logic for main and secondary viewports.
    {
        ...
        main_viewport->PlatformHandleRaw = (void*)SDL_GetPointerProperty(SDL_GetWindowProperties(m_sdlWnd), SDL_PROP_WINDOW_WIN32_HWND_POINTER, nullptr);
#elif defined(__APPLE__)
        main_viewport->PlatformHandleRaw = (void*)SDL_GetPointerProperty(SDL_GetWindowProperties(m_sdlWnd), SDL_PROP_WINDOW_COCOA_WINDOW_POINTER, nullptr);
#endif
    }
#endif
