    ...
    [
        ...
        class_<KeyBindingRegistrator>("DIK_keys")
            ...
            [
                ...
                value("DIK_NUMPAD_WWW",             int(SDL_SCANCODE_AC_HOME)),
//                 value("DIK_NUMPAD_MAIL",            int(SDL_SCANCODE_AC_MAIL)),
//                 value("DIK_NUMPAD_CALCULATOR",      int(SDL_SCANCODE_CALCULATOR)),
                value("DIK_NUMPAD_COMPUTER",        int(SDL_SCANCODE_AC_SEARCH)),
...
//                 value("DIK_BRIGHTNESSDOWN",         int(SDL_SCANCODE_DISPLAY_BRIGHTNESS_DOWN)),
//                 value("DIK_BRIGHTNESSUP",           int(SDL_SCANCODE_DISPLAY_BRIGHTNESS_UP)),
//                 value("DIK_DISPLAYSWITCH",          int(SDL_SCANCODE_DISPLAY_SWITCH)),
