...
keyboard_key keyboards[] =
{
    ...
    { "kWWW",                   SDL_SCANCODE_AC_HOME,                "WWW" },
//     { "kMAIL",                  SDL_SCANCODE_AC_MAIL,               "Mail" },
//     { "kCALCULATOR",            SDL_SCANCODE_CALCULATOR,         "Calculator" },
    { "kCOMPUTER",              SDL_SCANCODE_AC_SEARCH,           "My Computer" },
...
//     { "kBRIGHTNESSDOWN",        SDL_SCANCODE_DISPLAY_BRIGHTNESS_DOWN,     "Brightness Down" },
//     { "kBRIGHTNESSUP",          SDL_SCANCODE_DISPLAY_BRIGHTNESS_UP,       "Brightness Up" },
//     { "kDISPLAYSWITCH",         SDL_SCANCODE_DISPLAY_SWITCH,      "Display Switch" },
